...
dir.create(paste0('/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/isoTWAS/GTEx/output_overlap_ss_munged/', label, '_associations'), recursive = TRUE)
outFile_isotwas = paste0('/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/isoTWAS/GTEx/output_overlap_ss_munged/', label, '_associations/', trait, '_isoTWAS.tsv')
...
doneFile = paste0('/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/isoTWAS/GTEx/output_overlap_ss_munged/doneFile/',label,'_',trait,'_done_dev.tsv')
