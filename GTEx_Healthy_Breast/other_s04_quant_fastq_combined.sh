...
#BSUB -o /rsrch5/home/epi/bhattacharya_lab/users/sthead/isoqtl_GTEx/logs/quant_from_fastq_comb_%J_%I.out
#BSUB -e /rsrch5/home/epi/bhattacharya_lab/users/sthead/isoqtl_GTEx/logs/quant_from_fastq_comb_%J_%I.err
#BSUB -W 3:00
#BSUB -n 10
#BSUB -M 80
...
DIR_OUT=/rsrch5/home/epi/bhattacharya_lab/data/GTEx_v8/salmon_quantifications/combined_veigaNorm_gencodev45
TXINDEX_salmon=/rsrch5/home/epi/bhattacharya_lab/data/Veiga/STB/SQANTI3/orthogonal/short-read/salmon/combined_gencodev45_and_ESPRESSO_normal_filtered/index
THREADS=10
