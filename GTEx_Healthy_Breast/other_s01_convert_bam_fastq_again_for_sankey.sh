#!/bin/sh
#BSUB -J bam_to_fastq[1-5]
#BSUB -o /rsrch5/scratch/epi/sthead/sankey/logs/bam_to_fastq_gtex_breast_%J_%I.out
#BSUB -e /rsrch5/scratch/epi/sthead/sankey/logs/bam_to_fastq_gtex_breast_%J_%I.err
#BSUB -W 3:00
#BSUB -n 5
#BSUB -M 50
...
OUT_DIR_FASTQ="/rsrch5/scratch/epi/sthead/GTEx_v8/fastq" 
