...
out_dir="/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/qtltools/GTEx_nom_${prefix}"
bed_file="/rsrch5/home/epi/sthead/isoqtl_lr_breast/files_for_analysis/bed/GTEx_gene_exp_${assembly}_ODS${do_ods}_TMM${do_tmm}_VST${do_vst}_lstpm${lstpm}_doBC${do_bc}.bed.gz"
cov_file="/rsrch5/home/epi/sthead/isoqtl_lr_breast/files_for_analysis/covariates/GTEx_cov_qtltools_gene_${prefix}.txt"
...
script="/rsrch5/home/epi/sthead/isoqtl_lr_breast/scripts/GTEx/child_run_coloc_BC.R"
...
if [ -e "$eqtlFile" ]; then
  ...
  for pheno in overallBC lumA lumB lumBHER2neg HER2enriched TN; do
    ...
    outfile=/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/coloc/GTEx_${assembly}_${pheno}_${level}_results_chunk${i}.RData
...
out_dir="/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/qtltools/GTEx_nom_${prefix}"
bed_file="/rsrch5/home/epi/sthead/isoqtl_lr_breast/files_for_analysis/bed/GTEx_tx_exp_${assembly}_ODS${do_ods}_TMM${do_tmm}_VST${do_vst}_lstpm${lstpm}_doBC${do_bc}.bed.gz"
cov_file="/rsrch5/home/epi/sthead/isoqtl_lr_breast/files_for_analysis/covariates/GTEx_cov_qtltools_tx_${prefix}.txt"
...
eqtlFile=${out_dir}/nom_tx_chunk${i}.txt
