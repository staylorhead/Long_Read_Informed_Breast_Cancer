...
map_file="/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/qtltools/GTEx_perm_${prefix}/agg_gene_qtls_perm${num_perm}_normalized_full_FDR0.05.results.thresholds.txt"
