...
gtf_tumor <- "/rsrch5/home/epi/bhattacharya_lab/data/Veiga/STB/SQANTI3/ESPRESSO_normal/ESPRESSO_normal_corrected.gtf"
gtf_tumor <- data.frame(readGFF(gtf_tumor))

# Read in tumor assembly isoform classification table and format
classif <- fread("/rsrch5/home/epi/bhattacharya_lab/data/Veiga/STB/SQANTI3/ESPRESSO_normal/ESPRESSO_normal_classification.txt",header=T)
...
classif_filtered <- read.table("/rsrch5/home/epi/bhattacharya_lab/data/Veiga/STB/SQANTI3/ESPRESSO_normal_filtered/ESPRESSO_normal_filtered_classification.txt",header=T)
...
gtf_gencode <- "/rsrch5/home/epi/bhattacharya_lab/data/Placenta_LRRNAseq/STB/SQANTI3/gencode_v45_dedup.gtf"
...
gtf_combined[gtf_combined$source%in%c("novel","novel_isoform"),"source"] <- "normal_assembly"
...
# Save combined gtf
file.combined <- "/rsrch5/home/epi/bhattacharya_lab/data/Veiga/STB/SQANTI3/combined_gencodev45_and_ESPRESSO_normal_filtered.gtf"
