...
runGTEx_isotwas = function(gene){
  ...
  if (nrow(exp_current) > 0){
    ...
    if (length(snp_list) > 1){
      ...
      out_folder = paste0('/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/isoTWAS/GTEx/output_overlap_ss_munged')
      out_folder_isoTWAS = paste0('/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/isoTWAS/GTEx/output_overlap_ss_munged/',label,'_isoTWAS')
      out_folder_ld = paste0('/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/isoTWAS/GTEx/output_overlap_ss_munged/',label,'_LDMatrix')
      out_folder_doneFile = '/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/isoTWAS/GTEx/output_overlap_ss_munged/doneFile'
...
doneFile = paste0('/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/isoTWAS/GTEx/output_overlap_ss_munged/doneFile/done_models_', label, '.tsv')
