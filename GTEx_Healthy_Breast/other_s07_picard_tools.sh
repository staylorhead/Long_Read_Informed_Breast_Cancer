#!/bin/sh
#BSUB -J picard[1-440]
#BSUB -o /rsrch5/home/epi/bhattacharya_lab/users/sthead/isoqtl_GTEx/logs/picard_%J_%I.out
#BSUB -e /rsrch5/home/epi/bhattacharya_lab/users/sthead/isoqtl_GTEx/logs/picard_%J_%I.err
#BSUB -W 3:00
#BSUB -n 5
#BSUB -M 20
...
SAMPLES_FILE="/rsrch5/home/epi/sthead/isoqtl_GTEx/files_for_analysis/GTEx_breast_mammary_bam_files_with_sample_attrib.txt"
