...
load(paste0(finemap_dir,"/GTEx_aggregated_finemap_res_byL_",level,".RData"))
...
out_prefix <- paste0("/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/gwas_loci/GTEx_finemap/ld_results_chr",chr,"_",assembly,"_",level,"_k",k,"_L",L)
