#!/bin/bash
#BSUB -J "make_tsv[1-5]"
#BSUB -o /rsrch5/scratch/epi/sthead/sankey/logs/make_tsv_LR_breast_%J_%I.out
#BSUB -e /rsrch5/scratch/epi/sthead/sankey/logs/make_tsv_LR_breast_%J_%I.out
#BSUB -q short
#BSUB -W 1:00
#BSUB -n 1
#BSUB -M 20
...
samtools view ${DIR_ALIGN}/${SAMPLE}_Aligned.toTranscriptome.out.bam \
  | awk -F'\t' '{print $1 "\t" $3}' \
  | gzip > ${DIR_OUT}/${SAMPLE}_breast_LR.tsv.gz