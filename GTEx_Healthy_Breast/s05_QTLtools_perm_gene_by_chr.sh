...
out_dir="/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/qtltools/GTEx_perm_${prefix}"
...
QTLtools cis --vcf ${geno_file} --bed ${bed_file}.gz --permute ${num_perm} --region chr${chunk} --cov ${cov_file} --out gene_qtls_perm${num_perm}_normalized_${chunk}.txt --normal --seed 1219
