...
# -o /rsrch5/home/epi/bhattacharya_lab/users/sthead/isoqtl_GTEx/logs/build_salmon_index_for_requant_TCGA_BRCA_%J.log \
# /rsrch5/home/epi/bhattacharya_lab/users/sthead/isoqtl_GTEx/scripts/build_salmon_index_for_requantifying_TCGA_BRCA_fastqs.sh
...
DIR_OUT=/rsrch5/home/epi/bhattacharya_lab/data/Veiga/STB/SQANTI3/orthogonal/short-read/salmon/combined_gencodev45_and_ESPRESSO_normal_filtered
...
gffread ${GTF} \
  -g ${GENOME} \
  -w ${DIR_OUT}/GCA_000001405.15_GRCh38_no_alt_analysis_set_combined_gencodev45_and_ESPRESSO_normal_filtered.fasta
...
sh /rsrch5/home/epi/bhattacharya_lab/software/mashmap/bin/generateDecoyTranscriptome.sh \
 ...
 -a ${GTF} \
 -g ${GENOME} \
 -t ${DIR_OUT}/GCA_000001405.15_GRCh38_no_alt_analysis_set_combined_gencodev45_and_ESPRESSO_normal_filtered.fasta \
 -o ${DIR_OUT}
