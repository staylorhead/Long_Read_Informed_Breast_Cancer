...
#BSUB -o /rsrch5/scratch/epi/sthead/sankey/logs/align_star_gencode_tumor_%J_%I.out
#BSUB -e /rsrch5/scratch/epi/sthead/sankey/logs/align_star_gencode_tumor_%J_%I.out
#BSUB -q medium
#BSUB -W 5:00
#BSUB -n 8
#BSUB -M 80
