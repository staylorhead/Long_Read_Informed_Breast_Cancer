...
# File paths
qtlSummaryStats = paste0("/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/qtltools/TCGA_cond_",annot,"_ODS1_TMM1_VST1_lstpm0_doBC0_k",k,"_HC_genpc5/",level,"_qtls_cond_nperm",nperm,"_tum_normalized_full.txt.gz")
genFile = paste0("/rsrch5/home/epi/bhattacharya_lab/data/TCGA/BRCA/AffySNP6/VCF/normal/imputed/MAF0.01_passQC_impR2_03/autosome_unrelated_participant_ids_GT_and_DS_sorted_chr_labels.vcf.gz")
expressionBed = paste0("/rsrch5/home/epi/sthead/isoqtl_lr_breast/files_for_analysis/bed/TCGA_",level,"_exp_",annot,"_ODS1_TMM1_VST1_lstpm0_doBC0_tumor.bed.gz")
covFile = paste0("/rsrch5/home/epi/sthead/isoqtl_lr_breast/files_for_analysis/covariates/TCGA_cov_qtltools_",level,"_tumor_",annot,"_ODS1_TMM1_VST1_lstpm0_doBC0_k",k,"_HC_genpc5.txt")
...
covNames <- c("age","sex",paste0("hcp",1:k),paste0("PC",1:5))
...
save(fullres,file=paste0("/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/finemap/TCGA_",level,"_",annot,"_k",k,"_nperm",nperm,"_maf_filt",maf_filt,
