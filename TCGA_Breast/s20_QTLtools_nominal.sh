...
out_dir="/rsrch5/home/epi/bhattacharya_lab/users/sthead/isoqtl_lr_breast/results/qtltools/TCGA_nom_${prefix}"
...
out_dir="/rsrch5/home/epi/bhattacharya_lab/users/sthead/isoqtl_lr_breast/results/qtltools/TCGA_nom_${prefix}"
bed_file="/rsrch5/home/epi/sthead/isoqtl_lr_breast/files_for_analysis/bed/TCGA_tx_exp_${assembly}_ODS${do_ods}_TMM${do_tmm}_VST${do_vst}_lstpm${lstpm}_doBC${do_bc}_tumor.bed.gz"
