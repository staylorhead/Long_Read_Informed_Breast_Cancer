...
sd_dat <- sd_dat[sd_dat$dataset=="TCGA",]
...
for (quan in c("gencodev45","veigaTum","comb")) {
  ...
  if(quan=="gencodev45"){
          ...
          }else if(quan=="veigaTum"){
            gtf_file="/rsrch5/home/epi/bhattacharya_lab/data/Veiga/STB/SQANTI3/ESPRESSO_tumor_filtered/ESPRESSO_tumor_filtered.gtf"
          }
