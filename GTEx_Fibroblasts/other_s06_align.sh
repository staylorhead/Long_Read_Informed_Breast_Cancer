#BSUB -J star_align[1-504]%25
#BSUB -W 24:00
#BSUB -o /rsrch5/home/epi/sthead/isoqtl_lr_breast/logs/other/align_fibro_%J_%I.out
#BSUB -e /rsrch5/home/epi/sthead/isoqtl_lr_breast/logs/other/align_fibro_%J_%I.out
#BSUB -q medium 
#BSUB -n 4
#BSUB -M 50
