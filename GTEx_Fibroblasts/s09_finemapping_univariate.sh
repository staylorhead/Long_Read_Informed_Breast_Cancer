...
Rscript /rsrch5/home/epi/sthead/isoqtl_lr_breast/scripts/GTEx_fibro/child_finemapping_univariate.R ${level} ${assembly} ${k} ${nperm} ${maf_filt} ${rm_cov} ${nsets} ${LSB_JOBINDEX} 1 ${L}
