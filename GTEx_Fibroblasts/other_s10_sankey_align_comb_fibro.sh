#!/bin/bash
#BSUB -J "align_comb_fibro[1-5]"
#BSUB -o /rsrch5/scratch/epi/sthead/sankey/logs/align_star_comb_fibro_%J_%I.out
#BSUB -e /rsrch5/scratch/epi/sthead/sankey/logs/align_star_comb_fibro_%J_%I.out
#BSUB -q medium
#BSUB -W 5:00
#BSUB -n 8
#BSUB -M 80
...
TXINDEX_STAR="/rsrch5/scratch/epi/sthead/sankey/star_index_comb_fibro"
DIR_TEMP="/rsrch5/scratch/epi/sthead/sankey/temp_comb_fibro"
