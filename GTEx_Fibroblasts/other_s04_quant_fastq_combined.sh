#!/bin/sh
#BSUB -J gtex_quant[1-504]%100
#BSUB -o /rsrch5/home/epi/sthead/isoqtl_lr_breast/logs/other/quant_fibro_from_fastq_comb_%J_%I.out
#BSUB -e /rsrch5/home/epi/sthead/isoqtl_lr_breast/logs/other/quant_fibro_from_fastq_comb_%J_%I.err
#BSUB -W 5:00
#BSUB -n 10
#BSUB -M 120
...
DIR_OUT=/rsrch5/home/epi/bhattacharya_lab/data/GTEx_v8/salmon_quantifications/fibroblast_combined_gencodev45_and_ESPRESSO
TXINDEX_salmon=/rsrch5/home/epi/bhattacharya_lab/data/GTEx_v9/SQANTI3/orthogonal/Expression/short-read/salmon/GTEx_fibroblast/combined_gencodev45_and_ESPRESSO_fibroblast_filtered/index
THREADS=10
