...
# -o /rsrch5/home/epi/sthead/isoqtl_lr_breast/logs/other/build_salmon_index_for_requant_GTEx_fibro_%J.log \
# /rsrch5/home/epi/sthead/isoqtl_lr_breast/scripts/GTEx_fibro/other_s03_build_salmon_index_for_requantifying_GTEx_fastqs.sh
...
DIR_OUT=/rsrch5/home/epi/bhattacharya_lab/data/GTEx_v9/SQANTI3/orthogonal/Expression/short-read/salmon/GTEx_fibroblast/combined_gencodev45_and_ESPRESSO_fibroblast_filtered
...
gffread ${GTF} \
  -g ${GENOME} \
  -w ${DIR_OUT}/GCA_000001405.15_GRCh38_no_alt_analysis_set_combined_gencodev45_and_ESPRESSO_fibroblast_filtered.fasta
...
sh /rsrch5/home/epi/bhattacharya_lab/software/mashmap/bin/generateDecoyTranscriptome.sh \
 ...
 -a ${GTF} \
 -g ${GENOME} \
 -t ${DIR_OUT}/GCA_000001405.15_GRCh38_no_alt_analysis_set_combined_gencodev45_and_ESPRESSO_fibroblast_filtered.fasta \
 -o ${DIR_OUT}
