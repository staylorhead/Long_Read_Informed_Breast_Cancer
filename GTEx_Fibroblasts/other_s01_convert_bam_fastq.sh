#!/bin/sh
#BSUB -J bam_to_fastq[1-504]%25
#BSUB -o /rsrch5/home/epi/sthead/isoqtl_lr_breast/logs/other/fibro_bam_to_fastq_%J_%I.out
#BSUB -e /rsrch5/home/epi/sthead/isoqtl_lr_breast/logs/other/fibro_bam_to_fastq_%J_%I.err
#BSUB -W 3:00
#BSUB -n 5
#BSUB -M 50
