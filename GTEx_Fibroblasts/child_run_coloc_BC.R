...
pvar <- fread("/rsrch5/home/epi/sthead/isoqtl_lr_breast/files_for_analysis/geno/GTEx_MAF0.01_passQC/allchr.pvar")
...
save(coloc_results, file = paste0("/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/coloc/GTEx_fibro_",annot,"_",pheno,"_",level,"_results_chunk", chunk, ".RData"))
