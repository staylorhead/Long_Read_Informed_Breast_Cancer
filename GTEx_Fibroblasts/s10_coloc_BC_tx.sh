...
out_dir="/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/qtltools/GTEx_fibro_nom_${prefix}"
...
script="/rsrch5/home/epi/sthead/isoqtl_lr_breast/scripts/GTEx_fibro/child_run_coloc_BC.R"
...
if [ -e "$eqtlFile" ]; then
  ...
  for pheno in overallBC lumA lumB lumBHER2neg HER2enriched TN; do
    ...
    outfile=/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/coloc/GTEx_fibro_${assembly}_${pheno}_${level}_results_chunk${i}.RData
