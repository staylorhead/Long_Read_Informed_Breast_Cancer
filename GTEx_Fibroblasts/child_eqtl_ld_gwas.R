...
file <- paste0(eqtl_dir, "/GTEx_fibro_cond_", assembly, "_ODS1_TMM1_VST1_lstpm0_doBC0_k", k, "_HC_genpc5/", level, "_qtls_cond_nperm1000_normalized_full.txt.gz")
...
out_prefix <- paste0("/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/gwas_loci/GTEx_fibro_eqtl/ld_results_chr",chr,"_chunk",chunk,"_",assembly,"_",level,"_k",k)
