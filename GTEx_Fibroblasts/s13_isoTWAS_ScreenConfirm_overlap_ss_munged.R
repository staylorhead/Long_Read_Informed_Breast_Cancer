...
dirs <- list.dirs("/rsrch5/home/epi/sthead/isoqtl_lr_breast/results/isoTWAS/GTEx_fibro/output_overlap_ss_munged")
...
sd_dat <- sd_dat[sd_dat$dataset=="GTEx_fibro",]

for (quan in c("gencodev45","ESPRESSO","comb")) {
  ...
  if(quan=="gencodev45"){
          ...
          }else if(quan=="ESPRESSO"){
            gtf_file="/rsrch5/home/epi/bhattacharya_lab/data/GTEx_v9/SQANTI3/Cells_Cultured_fibroblasts_filtered/Cells_Cultured_fibroblasts_filtered_cleaned.gtf"
          }
