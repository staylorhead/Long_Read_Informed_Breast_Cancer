...
#BSUB -o /rsrch5/home/epi/sthead/isoqtl_lr_breast/logs/other/quant_fibro_from_fastq_gencodev45_%J_%I.out
#BSUB -e /rsrch5/home/epi/sthead/isoqtl_lr_breast/logs/other/quant_fibro_from_fastq_gencodev45_%J_%I.err
#BSUB -W 5:00
#BSUB -n 10
#BSUB -M 120
...
DIR_OUT=/rsrch5/home/epi/bhattacharya_lab/data/GTEx_v8/salmon_quantifications/fibroblast_gencodev45
